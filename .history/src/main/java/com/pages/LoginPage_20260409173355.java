...
private final String submitbtnlocator = "//input[@type='submit']";
    ...
    public void loginActions(String firstname, String lastname, String email, String password){
        ...
        safeFillTextbyIndex(firstnamelocator, firstname,3);
        safeFillTextbyIndex(lastnamelocator, lastname,2);
        safeFillTextbyIndex(emaillocator, email,4);
        safeFillTextbyIndex(passwordLLocator, password,4);
